...
const Login = () => {
    ...
    return (
        <div className="flex min-h-screen overflow-hidden">
            ...
            <div className="hidden lg:flex lg:w-1/2 bg-app-green relative items-center justify-center">
                ...
                <div className="relative text-center px-12">
                    ...
                    <motion.p 
                        ...
                        className="text-white/60 font-serif text-xl max-w-sm mx-auto"
                    >
                        {isLogin 
            ...
            <div className="flex-1 flex items-center justify-center px-4 py-12 bg-app-cream relative">
                                    ...
                                    <div className="relative">
                                        ...
                                        <div className="relative flex justify-center text-sm">
                                            <span className="px-2 bg-white text-gray-500">
                                                {isLogin ? "or login with social platforms" : "or register with social platforms"}
                                            </span>
                                        </div>
                                    </div>
                                    <div className="mt-4 flex justify-center gap-3">
                                        <button className="px-4 py-2 border border-gray-300 rounded-lg hover:bg-gray-50 transition-colors text-lg font-semibold">
                                            G
                                        </button>
                                        <button className="px-4 py-2 border border-gray-300 rounded-lg hover:bg-gray-50 transition-colors text-lg font-semibold">
                                            f
